          ...
          <div className="w-full max-w-md">
            <div className="flex items-center mb-12 gap-4">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(140.58deg, #4F4FDC 4.02%, #717AEA 95.98%)",
                }}
              >
                <div
                  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-10 w-10 rounded-lg flex items-center justify-center"
                  style={{
                    background:
                      "linear-gradient(142.73deg, #4F4FDC -43.15%, #717AEA 86.77%)",
                  }}
                >
                  <img
                    src="/logo.svg"
            ...
            <h2 className="text-3xl  mb-2 text-black font-bold">
              Enter Camera Url
            </h2>
            <p className="text-lg text-gray-600 mb-16">
              Fill details below to begin
            </p>
            ...
            >
              ...
              <button
                ...
                style={{
                  background:
                    "linear-gradient(90.84deg, #5D61E2 9.55%, #727BEA 90.45%)",
